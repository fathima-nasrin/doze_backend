    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
            'options' => json_encode([
                ...
                "logo" => [
                    'thumbnail' => 'https://storage.googleapis.com/dozemapfiles/doze.png',
                    'original' => 'https://storage.googleapis.com/dozemapfiles/doze.png',
                    'id' => 2298,
                ...
                "copyrightText" =>  "Copyright © DOZE. All rights reserved worldwide.",
                "externalText" =>  "DOZE",
